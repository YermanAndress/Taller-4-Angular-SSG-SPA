 ...
 * mostrando información como id, cliente, producto, fecha,
 * total y un badge visual que indica el estado de cada venta.
 *
 * @remarks
...
export class SalesTableComponent {
   ...
   * generalmente `ListSalesComponent`. Cada venta debe cumplir la interfaz `Sale`.
   */
  @Input() sales: Sale[] = [];
  /**
   * Mapeo de estados de venta a tipos de Badge.
